...
#include <cstdint> // For int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t, int64_t, uint64_t
#include <cstddef> // For size_t
#include <cstring> // For std::string
#include <string> // For std::string
#include <cmath> // For std::string
#include "esp_err.h" // For ESP error codes
#include "esp_log.h" // For ESP error codes
